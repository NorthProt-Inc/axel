...
|----------|---------------|-----------------|--------|--------|
| coord | — | 33 cycles | 0 | Active |
| arch | 1 cycle | 3 (FIX-AUDIT, FIX-PRE-IMPL, SYNC-001) | 0 | Idle |
| dev-core | 1 cycle | 1 (CORE-001) | 0 | Active (CORE-002, CORE-005) |
| dev-infra | — | 0 | 0 | Pending Phase C |
| dev-edge | — | 0 | 0 | Pending Phase D |
| quality | 1 cycle | 1 (QA-011) | 0 | Idle |
| research | — | 0 | 0 | Idle |
| devops | 2 cycles | 8 (SCAFFOLD-001~007 + FIX) | 0 | Idle (DEVOPS-001 queued) |
...
|---------|--------|---------|-------|
| `packages/core/` | 90% | N/A (@vitest/coverage-v8 pending) | — |
| `packages/infra/` | 80% | — | — |
...
| B: Core Sprint | **ACTIVE** | 32 | — | 30% (CORE-001+SYNC-001+SCAFFOLD-007 done. CORE-002~006+QA-012 remaining.) |
