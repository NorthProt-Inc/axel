...
|----------|---------------|-----------------|--------|--------|
| coord | — | 48 cycles | 0 | Active |
| arch | 2.5 cycles | 5 (FIX-AUDIT, FIX-PRE-IMPL, SYNC-001, SYNC-002, SYNC-003) | 1 (SYNC-004, overridden C46 by CTO) | **Active** — PLAN-AMEND-001 assigned |
| dev-core | 1.5 cycles | 6 (CORE-001~006) | 0 | Idle — all CORE tasks complete |
| dev-infra | 1 cycle | 8 (INFRA-001~005, COMMON-CB, FIX-INFRA-002, FIX-INFRA-003) | 0 | **Active** — FIX-INFRA-004 assigned |
| dev-edge | 1 cycle | 1 (EDGE-001) | 0 | **Active** — EDGE-002 (CLI channel) assigned |
| quality | 2 cycles | 3 (QA-011, QA-013, QA-016) | 1 (QA-012, cancelled C39) | Idle — QA-017 queued |
| research | — | 0 | 0 | Idle |
| devops | 1 cycle | 13 (SCAFFOLD-001~007 + FIX + DEVOPS-002/003/004 + FIX-INFRA-001 + DEVOPS-005) | 0 | **Active** — DEVOPS-006 assigned |
...
| D: Edge Sprint | **ACTIVE** | 47 | — | 27% (4/15 done: EDGE-001, FIX-INFRA-002/003, DEVOPS-005) |
